        ...
        <section>
            <article class="main_video_page">
                <div class="gray_opacity_radius" style="width:80%; height:600px; overflow: auto;">
                    ...
                    src="https://www.youtube.com/embed/cpXQKieH_Fc"
                    frameborder="0"
                    gesture="media"
                ...
                <div class="comment gray_opacity_radius">
                    ...
                    <div style="height:100px;">
                        <form class ="bar" action="Videos.php">
                            <input type ="text"
                        ...
                        <?php
                            $count = file_get_contents("count/count_0.txt");
                            $author = $_GET['author'];
                            $content = $_GET['content'];
                            if($author!=NULL && $content!=NULL){
                                $list = "list_0/".$count.".txt";
                                file_put_contents($list,'<div class ="author">'.$author.'</div>'.'<div class ="content_">'.$content.'</div>');
                                $count = $count + 1;
                                file_put_contents("count/count_0.txt", $count);
                            }
                        ?>
                    </div>
                    <div class ="bar">
                    ...
                    <?php
                        ...
                        for($i = 1; $i <= $count; $i++){
                            echo '<div class ="bar">'; 
                            echo file_get_contents("list_0/".$i.".txt");
                            echo '</div>';
                        }
                    ?>
                </div>
